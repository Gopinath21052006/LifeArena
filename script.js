...
// Spotify for your books 🎧📚 
const songs = [
  "music/NEFFEX - Grateful [Copyright Free] No.54 - NEFFEX (youtube).mp3",
];
...
say("Radio ready. Type play, pause, next or volume.");
...
input.addEventListener("keydown", e => {
  if (e.key === "Enter") {
    ...
    if (cmd.includes("play")) {
      ...
      let v = parseInt(cmd.replace(/\D/g, ""));
      if (!isNaN(v)) {
        player.volume = v / 100;
        say("Volume set to " + v + "%");
      }
